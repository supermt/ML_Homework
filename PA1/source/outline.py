...
if __name__ == "__main__":
  ...
  for percent in percents:
    ...
    indexes=set(np.random.randint(0,total_length/10,size=[1,total_length])[0])
    sampx_sub = sampx
    sampy_sub = sampy
    for index in indexes:
      sampy_sub[index] = sampy[index] + np.random.uniform(-50,50)
    
    LS.plot(sampx_sub,sampy_sub,color='g',linestyle='',marker='*',label="sample")
    RLS.plot(sampx_sub,sampy_sub,color='g',linestyle='',marker='*',label="sample")
    LASSO.plot(sampx_sub,sampy_sub,color='g',linestyle='',marker='*',label="sample")
    RR.plot(sampx_sub,sampy_sub,color='g',linestyle='',marker='*',label="sample")
    BR.plot(sampx_sub,sampy_sub,color='g',linestyle='',marker='*',label="sample")
